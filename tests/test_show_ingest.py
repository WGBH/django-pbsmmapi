...
assets_deleted_data_set['https://media.services.pbs.org/api/v1/shows/adfb2f9d-f61e-4613-ac58-ab3bde582afb/assets/'] = 'test_fixtures/nova_shows_adfb2f9d-f61e-4613-ac58-ab3bde582afb_assets_minus_one.json'
assets_deleted_data_set['https://media.services.pbs.org/api/v1/seasons/7f613b59-588b-4ec5-bcb1-a3d595b2579c/assets/'] = 'test_fixtures/nova_seasons_7f613b59-588b-4ec5-bcb1-a3d595b2579c_assets_minus_one.json'
assets_deleted_data_set['https://media.services.pbs.org/api/v1/specials/a3410528-7f72-47e8-b28d-6861693b9309/assets/'] = 'test_fixtures/nova_specials_a3410528-7f72-47e8-b28d-6861693b9309_assets_minus_one.json'
assets_deleted_data_set['https://media.services.pbs.org/api/v1/episodes/107268fc-0437-4877-8c3b-d5fdcef32737/assets/'] = 'test_fixtures/nova_episodes_107268fc-0437-4877-8c3b-d5fdcef32737_assets_minus_one.json'
...
class ShowIngestTestCase(unittest.TestCase):
    @mock.patch('pbsmmapi.api.api.requests.get',
    ...
    @mock.patch('pbsmmapi.api.api.requests.get',
                side_effect=mocked_requests_get)
    def reingest(self, mock_get, ingest_seasons=False,
                 ingest_specials=False, ingest_episodes=False):
        nova = PBSMMShow.objects.get(slug='nova')
    ...
    def test_show_ingested(self, mock_get):
        nova = PBSMMShow.objects.get(slug='nova')
        self.assertEqual(nova.object_id, UUID(
    ...
    def test_show_asset(self, mock_get):
        ...
        self.assertEqual(nova_show_asset.object_id, UUID(
            'bae3b21e-2465-4629-afce-1f192c7a11c9'))
    ...
    def test_season_asset(self, mock_get):
        ...
        landslides = PBSMMSeasonAsset.objects.get(
            slug='predicting-landslides-qh7jt9')
    ...
    def test_special_asset(self, mock_get):
        ...
        saturn = PBSMMSpecialAsset.objects.get(
            slug='front-row-seat-saturn-0vf9j2')
    ...
    def test_episode_asset(self, mock_get):
        ...
        make_life = PBSMMEpisodeAsset.objects.get(
            slug='can-we-make-life-hquxsp')
