...
from .forms import PBSMMCollectionCreateForm, PBSMMCollectionEditForm

class PBSMMCollectionAdmin(admin.ModelAdmin):
    model = PBSMMCollection
    form = PBSMMCollectionEditForm
    add_form = PBSMMCollectionCreateForm
    list_display = ('pk',  'object_id', 'title', 'date_last_api_update', 'last_api_status_color')
    ...
    fieldsets = (
        ...
        ('Collection Metadata', { 'classes': ('collapse',),
            'fields': (
                'featured',
            ),
        }),
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        return super(PBSMMCollectionAdmin, self).get_fieldsets(request, obj)
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        return super(PBSMMCollectionAdmin, self).get_form(request, obj, **kwargs)

admin.site.register(PBSMMCollection, PBSMMCollectionAdmin)